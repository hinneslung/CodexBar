...
enum WindowsProviderDiagnosticDecoder {
    ...
    private static let acceptedRawPercentRange = -1000.0...100_000.0
    ...
    static func decodeResult(
        data: Data,
        requestedProvider: WindowsProviderID,
        source: WindowsProviderSourcePresentation) throws -> WindowsProviderDiagnosticDecodeResult
    {
    ...
    private static func resetText(_ window: RateWindow) -> String? {
        ...
        if (40000...50000).contains(minutes) { return "Monthly" }
