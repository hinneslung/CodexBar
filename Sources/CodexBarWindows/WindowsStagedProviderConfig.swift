...
enum WindowsStagedProviderConfigError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        ...
        case let .validationRejected(message):
            message
        case .payloadTooLarge:
...
enum WindowsStagedProviderConfig {
    ...
    static func encodeManual(
        ...
        record: WindowsProviderCredentialRecord) throws -> (data: Data, source: String, revision: String)
    {
    ...
    static func encodeBridge(
        provider: WindowsProviderID,
        source: String = "api",
        companionValues: [String: String] = [:]) throws -> Data
    {
    ...
    private static func encode(
        ...
        tokenAccountToken: String? = nil) throws -> Data
    {
