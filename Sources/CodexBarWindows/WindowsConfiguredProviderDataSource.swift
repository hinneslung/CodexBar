...
struct WindowsConfiguredProviderDataSource: WindowsProviderDataSource, Sendable {
    ...
    private func resolvedCLI(
        ...
        windowsDirectory: String) async -> ResolvedCLI?
    {
    ...
    static func resolveCLI(
        ...
        bundled: @Sendable (_ distribution: String) async -> String?) async -> ResolvedCLI?
    {
    ...
    {
        if provider.sourceMode == .wsl, let selected = trimmed(provider.wslDistro) {
    ...
    private static func credentialFailure(
        ...
        discardsRefreshResult: Bool = false) -> WindowsProviderSnapshot
    {
        let snapshot = WindowsProviderSnapshot(
            provider: provider,
            availability: .error,
    ...
    private static func providerOrder(
        ...
        _ rhs: WindowsProviderConfiguration) -> Bool
    {
