...
struct WindowsWSLSourceDiscoveryTests {
    @Test
    func `default user home resolves only the registry selected non-root UID`() throws {
        ...
        try Data(
            "root:x:0:0:root:/root:/bin/bash\nselected:x:1000:1000::/home/selected:/bin/bash\n"
                .utf8).write(to: etc.appendingPathComponent("passwd"))
    ...
    @Test
    func `distribution names cannot escape the WSL localhost root`() {
