...
struct WindowsProviderDiagnosticDecoderTests {
    @Test
    func `schema 1.0 maps known windows confidence and resolved web source`() throws {
    ...
    @Test
    func `unknown usage windows are omitted`() throws {
    ...
    @Test
    func `wrong schema provider malformed date and absurd percentages fail closed`() {
    ...
    @Test
    func `over quota and negative percentages clamp for display`() throws {
    ...
    @Test
    func `oversized arrays strings and provider-specific detail objects fail closed`() {
    ...
    @Test
    func `diagnostic errors map to bounded local messages`() throws {
        let snapshot = try WindowsProviderDiagnosticDecoder.decode(
            data: Self.payload(
    ...
    @Test
    func `diagnostic failures retain the requested source without exposing failed`() throws {
    ...
    @Test
    func `only transient diagnostic categories request a retry`() throws {
    ...
    @Test
    func `diagnostic payload cannot contain both usage and an error`() {
        Self.expectFailure(
    ...
    @Test
    func `diagnostic source modes and successful source must match staged web route`() {
    ...
    private static func payload(
        ...
        settingsSourceMode: String? = nil) -> Data
    {
